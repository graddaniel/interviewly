...
Zgoda nieobowiązkowa`,
        ...
        martialStatuses: {
            singleMan: 'Samotny mężczyzna',
            singleWoman: 'Samotna kobieta',
            marriedMan: 'Żonaty mężczyzna',
            marriedWoman: 'Zamężna kobieta',
            widower: 'Wdowiec',
            widow: 'Wdowa',
            divorcedMan: 'Rozwiedziony mężczyzna',
            divorcedWoman: 'Rozwiedziona kobieta',
            separatedMan: 'Mężczyzna w separacji',
            separatedWoman: 'Kobieta w separacji',
        },
        profileRoles: {
            admin: 'admin',
            moderator: 'moderator',
...
Over the years, I’ve come to learn that designing collaboratively means putting your egos aside to make something that transcends the sum of its creators.`,
            ...
            respondents: {
                personalDataSubtitle: 'Dane osobiste',
